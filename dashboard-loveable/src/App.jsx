...
import CrossBorderPanel from './components/CrossBorderPanel'
    ...
    <div className="app-root">
        ...
        <div className="app-header-left">
          ...
          <div className="app-brand-col">
            <div className="app-brand">
              ...
              <span className="app-title">Ops Console</span>
            </div>
            <div className="app-subtitle">DRRMO Operator Dashboard · AAIH 2026</div>
          </div>
        </div>
      ...
      {state.phase === 'done' && decisionResult && (
        <div className="app-strip app-strip-done">
          ...
          <span style={{ textTransform: 'capitalize', fontWeight: 700 }}>{decisionResult.decision}</span>
      ...
      {!showPipeline && (
        <div className="app-body">
          <div className="app-form-section panel-lift">
          ...
          <div className="app-empty panel">
            ...
            <p className="app-empty-text">Submit a situation report to activate the 6-agent pipeline</p>
      ...
      {/* ── Results layout: left rail / main / right rail ───── */}
      {showPipeline && (
        <div className="ops-grid">
          ...
          <main className="ops-main">
            ...
            <AnalyticsSummary intake={state.agentOutputs?.intake ?? null} />

            <HazardMap location={state.agentOutputs?.intake?.location} />
          ...
          <aside className="ops-rail">
            <CrossBorderPanel />
            <EvacList />
            <AuditTrail reportId={state.reportId} outputs={state.agentOutputs} decisionResult={decisionResult} />
          </aside>
        </div>
      )}
    </div>
